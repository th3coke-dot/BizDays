...
export const metadata: Metadata = createPageMetadata({
  title: "Helligdager 2026",
  description:
    "Komplett liste over norske helligdager og røde dager i 2026, med datoer.",
  path: "/helligdager/2026",
});

export default function Helligdager2026Page() {
  const holidays = holidaysNO[2026];
    ...
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-12">
      ...
      <header className="mb-8">
        ...
        <p className="mt-3 text-[var(--muted)]">
          {holidays.length} røde dager i Norge i 2026. Se også{" "}
          <Link
            href="/helligdager/2027"
